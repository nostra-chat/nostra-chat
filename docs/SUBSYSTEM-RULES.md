# Nostra.chat subsystem rules

**Authority:** durable implementation invariants shared by contributors and
coding agents. Update this document whenever a subsystem change invalidates an
entry. Last reviewed against repository history: 2026-07-12.
