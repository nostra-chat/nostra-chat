...
export type BroadcastEvents = {
  ...
  'nostra_identity_loaded': {npub: string, displayName?: string, nip05?: string, protectionType: 'none' | 'pin' | 'passphrase'},
  'nostra_identity_locked': void,
  'nostra_identity_unlocked': {npub: string},
  'nostra_identity_updated': {displayName?: string, nip05?: string},
