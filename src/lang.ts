const lang = {
  ...
  'Update.Verdict.Offline': '\ud83d\udce1 Offline — could not check',
  ...
  'Update.Section.Sources': 'Verification sources',
  'Update.Sources.Caption': 'Before any signature check, the update manifest is fetched from these independent sources and compared. A conflict between sources blocks the update.',
