const lang = {
  ...
  'Update.HowItWorks.Description': 'On every launch Nostra.chat verifies that the loaded code matches what was installed. This protects you from compromised CDNs, man-in-the-middle attacks, and unauthorized updates.\n\nThree automatic checks:\n1) Service Worker URL — must match the one saved at first install.\n2) No unexpected Service Worker queued for installation.\n3) Manifest compared across three independent sources (CDN, IPFS, GitHub).\n\nIf you see the "possible compromise detected" alert: always verify from the official site before proceeding. If you just changed device, cleared the cache, or reinstalled manually it may be a false positive, and "Reset baseline" adopts the current state as the new trusted point.\n\nDo not reset if you suspect an active attack — in that case sign out and log in from the official site.',
