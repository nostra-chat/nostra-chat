const lang = {
  ...
  'ChatList.Main.EmptyPlaceholder.Subtitle': 'You have %s on Nostra.chat',
  'ChatList.Main.EmptyPlaceholder.SubtitleNoContacts': 'Use Nostra.chat app on your [Android](https://telegram.org/android) or [iOS](https://telegram.org/dl/ios) device to sync your contacts',
  ...
  'Deactivated.Subtitle': 'Nostra.chat supports only one active tab with the app.\nClick anywhere to continue using this tab.',
  'Deactivated.Version.Title': 'WebK has updated...',
  'Deactivated.Version.Subtitle': 'Another tab is running a newer version of Nostra.chat.\nClick anywhere to reload this tab.',
  ...
  'Notifications.Default': 'Give Nostra.chat permission to send notifications. You may need to refresh the page to see the changes.',
  ...
  'Message.Unsupported.Desktop': '__This message is currently not supported on Nostra.chat. Try [getdesktop.telegram.org](https://getdesktop.telegram.org/)__',
  'Message.Unsupported.Mobile': '__This message is currently not supported on Nostra.chat. Try [telegram.org/dl](https://telegram.org/dl/)__',
  ...
  'PushNotification.Message.Refreshing': 'Nostra.chat is syncing in the background...',
  'LogOut.Description': 'Are you sure you want to log out?\n\nNote that you can seamlessly use Nostra.chat on all your devices at once.',
  // "PushNotification.Action.Mute1d.Success": "Notification settings were successfully saved.",
  // it is from iOS
  ...
  'Video.Unsupported.Desktop': '__Unfortunately, this video can\'t be played on Nostra.chat. Try opening it with our [desktop app](https://getdesktop.telegram.org/) instead.__',
  'Video.Unsupported.Mobile': '__Unfortunately, this video can\'t be played on Nostra.chat. Try opening it with our [mobile app](https://telegram.org/dl/) instead.__',
  ...
  'BoostsViaGifts.EndSubtitle': {
    'one_value': 'Choose when %d subscriber of your channel will receive Nostra.chat Premium.',
    'other_value': 'Choose when %d subscribers of your channel will be randomly selected to receive Nostra.chat Premium.'
  },
  ...
  'BoostsViaGifts.DurationSubtitle': 'You can review the list of features and terms of use for Nostra.chat Premium [here]().',
  ...
  'Giveaway.Info': 'On **%s**, Nostra.chat will automatically select %s **%s**.',
  'Giveaway.Info.End': 'On **%s**, Nostra.chat automatically selected %s **%s**.',
  'Giveaway.Info.Date': 'On **%s**, Nostra.chat will automatically select %s **%s** after **%s**.',
  'Giveaway.Info.Date.End': 'On **%s**, Nostra.chat automatically selected %s **%s** after **%s**.',
  'Giveaway.Info.Several': 'On **%s**, Nostra.chat will automatically select %s **%s** and %s.',
  'Giveaway.Info.Several.End': 'On **%s**, Nostra.chat automatically selected %s **%s** and %s.',
  'Giveaway.Info.Several.Date': 'On **%s**, Nostra.chat will automatically select %s **%s** and %s after **%s**.',
  'Giveaway.Info.Several.Date.End': 'On **%s**, Nostra.chat automatically selected %s **%s** and %s after **%s**.',
  ...
  'Multiplier': '%s x %s',
  'Giveaway.Results': {
    'one_value': '%d winner of the giveaway was randomly selected by Nostra.chat and received private message with giftcode.',
    'other_value': '%d winners of the giveaway were randomly selected by Nostra.chat and received private messages with giftcodes.'
  },
  ...
  'Giveaway.Results.NoWinners': {
    'one_value': 'Due to the giveaway terms, no winner could be selected by Nostra.chat, **1** gift link was forwarded to channel administrators.',
    'other_value': 'Due to the giveaway terms, no winners could be selected by Nostra.chat, all **%d** gift links were forwarded to channel administrators.'
  },
  'Giveaway.Results.NoWinners.Stars': 'Due to the giveaway terms, no winners could be selected by Nostra.chat, all stars were credited to channel administrators.',
  ...
  'BoostsViaGifts.AdditionalPrizesSubtitleOff': 'Turn this on if you want to give the winners your own prizes in addition to Nostra.chat Premium subscriptions.',
  'BoostsViaGifts.AdditionalPrizesDetailed': {
    'one_value': '**%d** Nostra.chat Premium subscription for %s',
    'other_value': '**%d** Nostra.chat Premium subscriptions for %s'
  },
  'BoostsViaGifts.AdditionalPrizesDetailedWith': {
    'one_value': '**%d** %s with Nostra.chat Premium subscription for %s',
    'other_value': '**%d** %s with Nostra.chat Premium subscriptions for %s'
  },
  ...
  'Giveaway.With': 'with',
  'Giveaway.WithSubscriptionsSingle': 'Nostra.chat Premium subscription for %s',
  'Giveaway.WithSubscriptionsPlural': 'Nostra.chat Premium subscriptions for %s',
  'Giveaway.WithStars': {
  ...
  'Giveaway.Results.Subtitle': {
    'one_value': '%1$d winner of the **[Giveaway]()** was randomly selected by Nostra.chat.',
    'other_value': '%1$d winners of the **[Giveaway]()** were randomly selected by Nostra.chat.'
  },
  ...
  'GiftCode.ShareReceived': 'This link allows you or **[anyone you choose]()** to activate a **Nostra.chat Premium** subscription.',
  'GiftModal.Title.You': 'You gifted **%1$s** a %2$s subscription to Nostra.chat Premium.',
  ...
  'SimilarChannels.Unlock': {
    'one_value': 'Subscribe to **[Nostra.chat Premium]()** to unlock up to **%d** similar channel.',
    'other_value': 'Subscribe to **[Nostra.chat Premium]()** to unlock up to **%d** similar channels.'
  },
  ...
  'Boost.GetMoreBoosts': {
    'one_value': 'To boost **%1$s**, get **%2$d** more boost by gifting **Nostra.chat Premium** to a friend.',
    'other_value': 'To boost **%1$s**, get **%2$d** more boosts by gifting **Nostra.chat Premium** to a friend.'
  },
  'Boost.Reassign.Description': 'To boost **%1$s**, reassign a previous boost or %2$s to a friend to get %3$s.',
  'Boost.GiftPremium': '**[gift Nostra.chat Premium]()**',
  'Boost.Additional': {
  ...
  'Boost.Reassign.Wait': 'Wait until the boost is available or get %s by gifting a **[Nostra.chat Premium]()** subscription.',
  ...
  'Privacy.VoiceMessagesPremiumCaption': 'Subscribe to Nostra.chat Premium to restrict who can send you voice or video messages.\n\n**[What is Nostra.chat Premium?]()**',
  ...
  'PrivacySettings.Messages.PremiumError': 'Only subscribers of [Nostra.chat Premium]() can restrict receiving messages.',
  ...
  'OnlyPremiumCanMessage': '**%s** only accepts messages from contacts and **[Nostra.chat Premium]()** subscribers.',
  ...
  'Rtmp.MediaViewer.Failed.Description': 'Nostra.chat doesn\'t see any stream coming from your streaming app. Please make sure you entered the right Server URL and Stream Key in your app.',
  ...
  'MultiAccount.AccountsLimitDescription': 'You have reached the limit of **3** connected accounts. You can add more by subscribing to **Nostra.chat Premium**.',
  ...
  'InviteViaLink.Premium.Subscribe': 'Subscribe to Nostra.chat Premium',
  ...
  'Frozen.Violation.Subtitle': 'Your account was frozen for breaking Nostra.chat\'s Terms of Service.',
  ...
  'Verified.Bot': 'This bot is verified as official by the representatives of Nostra.chat.',
  'Verified.Channel': 'This channel was verified by Nostra.chat.',
  'Verified.Group': 'This group was verified by Nostra.chat.',
  // 'SavedMessages.Count': {
  ...
  'Summary.Limited.Text': 'Subscribe to [Nostra.chat Premium]() to increase summary limits.',
  ...
  'NostraPremiumSubscribedTitle': 'You are all set!',
  'NostraPremiumSubscribedSubtitle': 'Thank you for subscribing to **Nostra.chat Premium**.\nHere’s what is now unlocked.',
  'NostraPremiumPeerTitle': '%s is a subscriber of **Nostra.chat Premium**',
  'NostraPremiumPeerSubtitle': 'Owners of **Nostra.chat Premium** accounts have exclusive access to multiple additional features.',
  'NostraPremiumPeerTitleEmojiStatus': '%s set this emoji from [%s]() as their current status.',
  'NostraPremiumPeerTitleEmojiStatusNoPack': '%s set this emoji as their current status.',
  'NostraPremiumPeerSubtitleEmojiStatus': 'Emoji statuses are a premium feature. Other features included in **Nostra.chat Premium**:',
  ...
  'ContactJoined': 'Contact joined Nostra.chat',
  'Loading': 'Loading...',
  'Unblock': 'Unblock',
  ...
  'PrivacyPhoneInfo': 'Users who have your number saved in their contacts will also see it on Nostra.chat.',
  'PrivacyPhoneInfo3': 'Users who add your number to their contacts will see it on Nostra.chat only if they are your contacts.',
  ...
  'UsernameHelp': 'You can choose a username on **Nostra.chat**. If you do, people will be able to find you by this username and contact you without needing your phone number.\n\nYou can use **a–z**, **0–9** and underscores. Minimum length is **5** characters.',
  'Phone': 'Phone',
  ...
  'YourEmailSkipWarningText': 'No, seriously.\n\nIf you forget your password, you will lose access to your Nostra.chat account. There will be no way to restore it.',
  ...
  'NostraFeatures': 'Nostra.chat Features',
  ...
  'NoUsernameFound': 'There is no Nostra.chat account with this username.',
  ...
  'ReportSentInfo': 'Nostra.chat moderators will review your report.\nThank you for your cooperation!',
  ...
  'SessionsListInfo': 'The official Nostra.chat app is available for Android, iPhone, iPad, Windows, macOS and Linux.',
  'SponsoredMessage': 'ad',
  ...
  'NostraFeaturesUrl': 'https://nostra.chat/features',
  'ScamMessage': 'SCAM',
  'FakeMessage': 'FAKE',
  ...
  'PaymentCardSavePaymentInformationInfoLine1': 'You can save your payment info for future use. It will be stored directly with the payment provider. Nostra.chat has no access to your credit card data.',
  'Done': 'Done',
  ...
  'PrivacyPaymentsClearInfo': 'You can delete your shipping info and instruct all payment providers to remove your saved credit cards. Note that Nostra.chat never stores your credit card data.',
  ...
  'LimitReachedPinDialogs': 'You can\'t pin more than %1$d chats to the top. Unpin some that are currently pinned – or subscribe to **Nostra.chat Premium** to double the limit to **%2$d** chats.',
  ...
  'LimitReachedCommunities': 'You are a member of **%1$d** groups and channels. Please leave some before joining a new one — or subscribe to **Nostra.chat Premium** to double the limit to **%2$d** groups and channels.',
  ...
  'WebSessionsTitle': 'Logged In with Nostra.chat',
  'TerminateWebSessionText': 'Are you sure you want to disconnect %1$s?',
  'Disconnect': 'Disconnect',
  'TerminateAllWebSessions': 'Disconnect All Websites',
  'AreYouSureWebSessions': 'Are you sure you want to disconnect all websites where you logged in with Nostra.chat?',
  'ClearOtherWebSessionsHelp': 'You can log in on websites that support signing in with Nostra.chat.',
  'TerminateWebSessionInfo': 'Click to disconnect from your Nostra.chat account.',
  'EnablePhotoSpoiler': 'Hide with spoiler',
  'DisablePhotoSpoiler': 'Remove spoiler',
  'LimitReachedFolders': 'You have reached the limit of **%1$d** folders. You can double the limit to **%2$d** folders by subscribing to **Nostra.chat Premium**.',
  ...
  'LimitReachedSharedFolderInvites': 'You have reached the limit of **%1$d** links. You can double the limit to **%2$d** links by subscribing to **Nostra.chat Premium**.',
  ...
  'GiftNostraPremiumTitle': 'Gift Nostra.chat Premium',
  'GiftNostraPremiumDescription': 'Give **%1$s** access to exclusive features with **Nostra.chat Premium**.',
  ...
  'ActionGiftPremiumSubtitle2': 'Subscription for exclusive Nostra.chat features.',
  'ChatAdmin': 'admin',
  ...
  'ChannelAntiSpamInfo': 'Nostra.chat will filter more spam, but may occasionally affect ordinary messages. You can report False Positives in Recent Actions.',
  'ChannelLinkInfo': 'Anyone who has Nostra.chat installed will be able to join your channel by following this link.',
  ...
  'BotWebAppDisclaimerSubtitle': 'You are about to use a mini app operated by an independent party **not affiliated with Nostra.chat**. You must agree to the Terms of Use for mini apps to continue.',
  ...
  'PremiumNeededForBoosting': 'Only **Nostra.chat Premium** subscribers can boost channels. Do you want to subscribe to **Nostra.chat Premium**?',
  ...
  'CantBoostWithGiftedPremiumDescription': 'Because your **Nostra.chat Premium** subscription was gifted to you, you can\'t use it to boost channels.',
  'MoreBoosts': {
  ...
  'BoostingGiveawayJustStarted': '%s just started a giveaway of Nostra.chat Premium subscriptions to its followers.',
  'BoostingWinnersDate': '**Winners Selection Date**',
  'BoostingGiveawayPrizes': '**Giveaway Prizes**',
  'BoostingGiveawayMsgInfoPlural1': {
    'other_value': '**%1$d** Nostra.chat Premium'
  },
  ...
  'BoostingGiveawayHowItWorksText': {
    'one_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s Nostra.chat Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s Nostra.chat Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingGiveawayHowItWorksTextEnd': {
    'one_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s Nostra.chat Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s Nostra.chat Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingReceivedPrizeDuration': 'Your prize is a **Nostra.chat Premium** subscription for %s.',
  'BoostingUnclaimedPrize': 'Unclaimed Prize',
  'BoostingYouHaveUnclaimedPrize': 'You have an unclaimed prize from a giveaway by **%s**.',
  'BoostingUnclaimedPrizeDuration': 'This prize is a **Nostra.chat Premium** subscription for %s.',
  ...
  'BoostingReceivedGiftDuration': 'Your gift is a **Nostra.chat Premium**\nsubscription for %s.',
  'BoostingUsedGiftLink': 'Used Gift Link',
  'BoostingGiftLink': 'Gift Link',
  'BoostingLinkUsed': 'This link was used to activate\na **Nostra.chat Premium** subscription.',
  'BoostingLinkAllows': 'This link allows you to activate\na **Nostra.chat Premium** subscription.',
  'BoostingLinkAllowsToUser': 'This link allows **%1$s** to activate a **Nostra.chat Premium** subscription.',
  ...
  'BoostingDate': 'Date',
  'BoostingNostraPremiumFor': 'Nostra.chat Premium for %s',
  ...
  'BoostingPremium': 'Nostra.chat Premium',
  'BoostingStars': 'Nostra.chat Stars',
  ...
  'LimitReachedChatInFolders': 'Sorry, you can\'t add more than **%1$d** chats to a folder. You can increase this limit to **%2$d** by subscribing to **Nostra.chat Premium**.',
  ...
  'NostraPremiumUserGiftedPremiumDialogTitleWithPlural': '**%1$s** has gifted you a %2$s subscription to Nostra.chat Premium.',
  'NostraPremiumUserGiftedPremiumDialogTitleWithPluralSomeone': 'Someone has gifted you a %1$s subscription to Nostra.chat Premium.',
  'NostraPremiumUserGiftedPremiumDialogSubtitle': 'You now have access to additional features.',
  'NostraPremiumUserGiftedPremiumOutboundDialogSubtitle': '**%1$s** now has access to additional features.',
  'GiftMonths': {
    'one_value': '%1$d-month',
    'other_value': '%1$d-months'
  },
  ...
  'GiftPremiumActivateErrorTitle': 'You already have Nostra.chat Premium',
  ...
  'PrivacyLastSeenPremium': 'Subscribe to Nostra.chat Premium',
  ...
  'PrivacyLastSeenPremiumForPremium': 'Subscribed to Nostra.chat Premium',
  'PrivacyLastSeenPremiumInfoForPremium': 'Because you are a Nostra.chat Premium subscriber, you will see the last seen and read time of all users who are sharing it with you – even if you are hiding yours.',
  ...
  'PremiumReadButton2': 'Subscribe to Nostra.chat Premium',
  ...
  'PremiumLastSeenButton2': 'Subscribe to Nostra.chat Premium',
  ...
  'AdHidden': 'You will no longer see ads from Nostra.chat.',
  'SponsoredMessageAdWhatIsThis': 'what\'s this?',
  'RevenueSharingAdsAlertSubtitle': 'Nostra.chat Ads are very different from ads on other platforms. Ads such as this one:',
  'RevenueSharingAdsInfo1Title': 'Respect Your Privacy',
  'RevenueSharingAdsInfo1Subtitle': 'Ads on Nostra.chat do not use your personal information and are based on the channel in which you see them.',
  'RevenueSharingAdsInfo2Title': 'Help the Channel Creator',
  'RevenueSharingAdsInfo2Subtitle': '50% of the revenue from Nostra.chat Ads goes to the owner of the channel where they are displayed.',
  'RevenueSharingAdsInfo3Title': 'Can Be Removed',
  'RevenueSharingAdsInfo3Subtitle': 'You can turn off ads by subscribing to **Nostra.chat Premium**, and Level %1$s channels can remove them for their subscribers.',
  'RevenueSharingAdsInfo4Title': 'Can I Launch an Ad?',
  'RevenueSharingAdsInfo4Subtitle2': 'Anyone can create an ad to display in this channel — with minimal budgets. Check out the **Nostra.chat Ad Platform** for details. %1$s',
  ...
  'NostraStars': 'Nostra.chat Stars',
  'NostraStarsInfo': 'Buy Stars to unlock content and services\nin mini apps on Nostra.chat.',
  ...
  'MenuNostraStars': 'My Stars',
  'MenuNostraStarsTon': 'My TON',
  'StarsCount': {
    'one_value': '%d Star',
    'other_value': '%d Stars'
  },
  ...
  'FactCheckToast': 'This clarification was provided by Nostra.chat.',
  'FactCheckFooter': 'This clarification was provided by Nostra.chat.',
  ...
  'AnimatedEffectPremium': 'Subscribe to **Nostra.chat Premium** to add this animated effect.',
  ...
  'ActionGiftStarsSubtitle': 'With Stars, **%s** is able to unlock content and services on Nostra.chat.',
  'ActionGiftStarsSubtitleYou': 'Use Stars to unlock content and services on Nostra.chat.',
  'GiftStarsTitle': 'Gift Stars',
  'GiftStarsSubtitle': 'With Stars, **%s** will be able to unlock content and services on Nostra.chat.',
  ...
  'StarGiftUpgradeTransferableText': 'Send your upgraded gift to any of your friends on Nostra.chat.',
  'StarGiftUpgradeTransferableTextPrepaid': '%s will be able to send the gift to anyone on Nostra.chat.',
  ...
  'StarGiftValueAboutAverage': 'The average sale price of **%s** gifts on Nostra.chat and Fragment over the past month.',
  'StarGiftValueAboutLastFragment': 'This is the price at which **%s** was last sold on Fragment',
  'StarGiftValueAboutLastNostra': 'This is the price at which **%s** was last sold on Nostra.chat',
  ...
  'StarGiftMinimumPriceTooltip': '**%s** is the floor price for **%s** gifts listed on Nostra.chat and Fragment.',
  'StarGiftAveragePrice': 'Average Price',
  'StarGiftAveragePriceTooltip': '**%s** is the average sale price of **%s** gifts on Nostra.chat and Fragment over the past month.',
  'StarGiftViewResaleNostra': '%s for sale on Nostra.chat %s',
  ...
  'NostraStarsGift': 'Gift Stars to Friends',
  'StarsSentText': {
  ...
  'Reported2': 'Nostra.chat moderators will review your report. Thank you!',
  ...
  'Contacts.PhoneNumber.NotRegistred': 'The person with this phone number is not registered on Nostra.chat yet.',
  'Channel.UsernameAboutChannel': 'People can share this link with others and can find your channel using Nostra.chat search.',
  'Channel.UsernameAboutGroup': 'People can share this link with others and find your group using Nostra.chat search.',
  ...
  'Chat.Service.PeerJoinedNostra': '%@ joined Nostra.chat',
  ...
  'Chat.Message.Ad.Text': 'Unlike other apps, Nostra.chat never uses your private data to target ads. Sponsored messages on Nostra.chat are based solely on the topic of the public channels in which they are shown. This means that no user data is mined or analyzed to display ads, and every user viewing a channel on Nostra.chat sees the same sponsored messages.\n\nUnlike other apps, Nostra.chat doesn\'t track whether you tapped on a sponsored message and doesn\'t profile you based on your activity. We also prevent external links in sponsored messages to ensure that third parties can’t spy on our users. We believe that everyone has the right to privacy, and technological platforms should respect that.\n\nNostra.chat offers a free and unlimited service to hundreds of millions of users, which involves significant server and traffic costs. In order to remain independent and stay true to its values, Nostra.chat developed a paid tool to promote messages with user privacy in mind. We welcome responsible advertisers at:\n\n%@\n\nSponsored Messages are currently in test mode. Once they are fully launched and allow Nostra.chat to cover its basic costs, we will start sharing ad revenue with the owners of public channels in which sponsored messages are displayed.\n\nOnline ads should no longer be synonymous with abuse of user privacy. Let us redefine how a tech company should operate – together.',
  ...
  'CustomEmoji.PremiumAlert': 'Subscribe to Nostra.chat Premium to unlock this emoji. [Read More]()',
  'Date.Today': 'Today',
  ...
  // 'LiteMode.Key.animations.Info': 'Other animations that make Nostra.chat look amazing.',
  ...
  'PrivacySettings.Voice.PremiumError': 'Only subscribers of [Nostra.chat Premium]() can restrict receiving Voice and Video Messages.',
  ...
  'PrivacySettingsController.P2p.Desc': 'Disabling peer-to-peer will relay all calls through Nostra.chat servers to avoid revealing your IP address, but may slightly decrease audio and video quality.',
  ...
  'TwoStepAuth.GenericHelp': 'You have enabled Two-Step verification.\nYou\'ll need the password you set up here to log in to your Nostra.chat account.',
  ...
  'Premium.Boarding.NoAds.Info': 'No more ads in public channels where Nostra.chat sometimes shows ads.',
  ...
  'Premium.Boarding.Badge.Info': 'An exclusive badge next to your name showing that you subscribe to Nostra.chat Premium.',
  ...
  'Premium.Boarding.Title': 'Nostra.chat Premium',
  'Premium.Boarding.Info': 'Go **beyond the limits** and **unlock dozens of exclusive** features by subscribing to **Nostra.chat Premium**.',
  'Premium.Boarding.Got.Title': 'You are all set!',
  'Premium.Boarding.Got.Info': 'Thank you for subscribing to Nostra.chat Premium. Here\'s what is now unlocked.',
  'Premium.Boarding.Peer.Title': '[%@](profile) is a subscriber of\nNostra.chat Premium',
  'Premium.Boarding.Peer.Info': 'Owners of Nostra.chat Premium accounts have exclusive access to multiple additional features.',
  ...
  'Premium.Boarding.About.Title': 'About Nostra.chat Premium',
  'Premium.Boarding.About.Text': 'While the free version of Nostra.chat already gives its users more than any other messaging application, **Nostra.chat Premium** pushes its capabilities even further.\n\n**Nostra.chat Premium** is a paid option, because most Premium Features require additional expenses from Nostra.chat to third parties such as data center providers and server manufacturers. Contributions from **Nostra.chat Premium** users allow us to cover such costs and also help Nostra.chat stay free for everyone.',
  'Premium.Boarding.About.Tos': 'By purchasing a Premium subscription, you agree to the Nostra.chat [Terms of Service](terms) and [Privacy Policy](privacy).',
  'Premium.Boarding.AppStore.Cancelled': 'Purchase was canceled or failed.',
  'Premium.Boarding.AppStore.Success': 'You successfully subscribed for Nostra.chat Premium.',
  ...
  'Premium.Offset.AlreadyHave': 'You already have Nostra.chat Premium.',
  ...
  'Language.TranslateMessages.Channel.Premium': 'Subscribe to [Nostra.chat Premium](premium) to translate entire chats.',
  ...
  'Chat.DownloadLimit.Text': {
    'one_value': 'Subscribe to [Nostra.chat Premium]() to increase download speeds %d time.',
    'other_value': 'Subscribe to [Nostra.chat Premium]() to increase download speeds %d times.'
  },
  'Chat.UploadLimit.Text': {
    'one_value': 'Subscribe to [Nostra.chat Premium]() to increase upload speeds %d time.',
    'other_value': 'Subscribe to [Nostra.chat Premium]() to increase upload speeds %d times.'
  },
  'Chat.Service.Refund': '%@ refunded %@',
  'EnableDarkMode': 'Enable Dark Mode',
  'DisableDarkMode': 'Disable Dark Mode',
  'DisableAnimations': 'Disable Animations',
  'AudioAndVideoTranscription.PremiumAlert': 'Subscribe to Nostra.chat Premium to unlock video and audio transcription. [Read More]()',
  ...
  'PasscodeLock.Description': 'When a passcode is set, a lock icon appears above your chat list. Tap it to lock your Nostra.chat.',
  ...
  'PasscodeLock.TapToLock': 'Tap to lock Nostra.chat.',
  ...
  'BotStorySharingNotSupported': 'Sharing to Stories is not supported in the Web app. Please use one of Nostra.chat\'s mobile apps.',
  ...
  'VerificationCodesBotDescription': 'Third-party services, like websites and stores, can send verification codes to your phone number via Nostra.chat instead of SMS. Such codes will appear in this chat.\n\nIf you didn\'t request any codes – don\'t worry! Most likely, someone made a mistake when entering their number.',
  ...
  'StarsRating.Subtitle': 'This rating reflects **%s**’s activity on Nostra.chat. What affects it:',
  'StarsRating.SubtitleMy': 'This rating reflects your activity on Nostra.chat. What affects it:',
  'StarsRating.Row1Title': 'Gifts from Nostra.chat',
  'StarsRating.Row1Subtitle': '100% of the Stars spent on gifts purchased from Nostra.chat.',
  ...
  'EmailSetup.ChangeSubtitle': 'You will receive Nostra.chat login codes via email and not SMS. Please enter an email address to which you have access.',
  ...
  // App Update / PWA version control
  'Update.Tab.Title': 'App Updates',
  'Update.Section.Installed': 'Installed',
  'Update.Section.Integrity': 'Integrity',
  'Update.Section.Actions': 'Actions',
  'Update.Section.About': 'About this protection',
  'Update.Row.CurrentVersion': 'Current version',
  'Update.Row.LatestVersion': 'Latest version',
  'Update.Value.UpdateAvailable': '%1$s (update available)',
  'Update.Value.UpToDate': '%1$s (up to date)',
  'Update.Row.InstalledSwUrl': 'Installed Service Worker URL',
  'Update.Row.ActiveSw': 'Active Service Worker',
  'Update.Row.LastCheck': 'Last check',
  'Update.Row.IntegrityStatus': 'Integrity status',
  'Update.Row.WaitingSw': 'Waiting Service Worker',
  'Update.Row.PendingFinalization': 'Pending update finalization',
  'Update.Row.HowItWorks': 'How it works',
  'Update.Row.HowItWorks.Subtitle': 'Why this safeguard exists and when to reset',
  'Update.Value.Unknown': 'unknown',
  'Update.Value.NotSet': 'not set',
  'Update.Value.None': 'none',
  'Update.Value.Never': 'Never',
  'Update.Value.NotCheckedYet': 'Not checked yet',
  'Update.Value.Yes': 'Yes',
  'Update.Value.No': 'No',
  'Update.Value.PendingYesWithVersion': 'Yes — v%1$s',
  'Update.RelativeTime.JustNow': 'just now',
  'Update.RelativeTime.MinutesAgo': '%1$dm ago',
  'Update.RelativeTime.HoursAgo': '%1$dh ago',
  'Update.RelativeTime.DaysAgo': '%1$dd ago',
  'Update.Verdict.Verified': '\u2705 Verified across all sources',
  'Update.Verdict.VerifiedPartial': '\u26a0\ufe0f Partially verified',
  'Update.Verdict.Conflict': '\u274c Conflict detected',
  'Update.Verdict.Insufficient': '\u2139\ufe0f Insufficient sources',
  'Update.Verdict.Offline': '\ud83d\udce1 Offline — no source could be reached',
  'Update.Verdict.Error': '❌ Sources replied but responses are invalid — see Diagnostics',
  'Update.Action.CheckForUpdates': 'Check for updates',
  'Update.Action.Checking': 'Checking…',
  'Update.Action.CheckComplete': 'Check complete',
  'Update.Action.CheckFailed': 'Check failed: %1$s',
  'Update.Action.OK': 'OK',
  'Update.Action.Reinstall': 'Reinstall app',
  'Update.Action.ReinstallConfirm': 'Reinstall & reload',
  'Update.Action.InstallNow': 'Install update now',
  'Update.Action.InstallNoneAvailable': 'No update available — run a check first.',
  'Update.Action.InstallFailed': 'Could not open the update prompt: %1$s',
  'Update.Section.Notifications': 'Update notifications',
  'Update.Row.SnoozeStatus': 'Deferred update',
  'Update.Value.SnoozeInactive': 'None — you\'ll be prompted as soon as a new update is verified',
  'Update.Value.SnoozeActive': 'v%1$s — hidden until %2$s',
  'Update.Action.ClearSnooze': 'Clear snooze',
  'Update.Action.SnoozeCleared': 'Snooze cleared — the update prompt will reappear at the next check',
  'Update.Confirm.ClearSnoozeTitle': 'Clear update snooze',
  'Update.Confirm.ClearSnoozeDescription': 'Removes the deferred state for this update. The consent popup will appear again at the next automatic or manual check.',
  'Update.Row.PendingSignature': 'Pending update signature',
  'Update.Value.PendingSignatureFor': 'For version %1$s',
  'Update.Signature.Fingerprint': 'Signing key',
  'Update.Signature.MatchesInstalled': 'matches the installed key',
  'Update.Signature.DifferentFromInstalled': 'different from the installed key',
  'Update.Signature.NoFingerprint': 'This manifest does not declare a signing key fingerprint',
  'Update.Signature.Rotation': 'Rotates signing key to',
  'Update.Section.Diagnostics': 'Diagnostics',
  'Update.Diagnostics.Caption': 'Technical details useful for support and debugging — you don\'t need these during normal use.',
  'Update.Row.ShowDiagnostics': 'Show technical details',
  'Update.Row.HideDiagnostics': 'Hide technical details',
  'Update.Row.SourceBreakdown': 'Per-source breakdown',
  'Update.Row.SourceBreakdown.Subtitle': 'Result from each manifest source at the last check',
  'Update.Section.Advanced': 'Advanced',
  'Update.Advanced.Caption': 'Recovery. Use when the app seems stuck or the integrity check keeps failing.',
  'Update.Row.Reinstall.Subtitle': 'Re-download the app from its verified sources. Your identity and chats stay on this device.',
  'Update.Reinstall.ConfirmTitle': 'Reinstall app',
  'Update.Reinstall.ConfirmDescription': 'Clears the cached code and forces the app to re-download from its verified sources — exactly as on first install. Trust the fresh copy like you trusted the app originally.\n\nYour Nostra identity, chats, and contacts stay on this device. You need to be online for this to work.\n\nUse this if the app seems stuck on an old version, or if the integrity check keeps failing.',
  'Update.Confirm.ProtectionTitle': 'Update protection',
  'Update.HowItWorks.Description': 'Nostra.chat verifies every update end to end, from its manifest to the consent popup you see before installing it.\n\n1) Manifest cross-check\nOn each launch the update manifest is fetched from several independent sources (CDN, IPFS gateway, GitHub) and compared. A disagreement between sources blocks the update.\n\n2) Cryptographic signature\nThe manifest is signed with an offline release key. The app verifies the signature against the key fingerprint baked into the currently-installed bundle. An unsigned or wrong-signed manifest is rejected — even if the cross-check succeeds.\n\n3) Your consent\nA verified update never installs silently. A popup asks you to review the version, changelog, and signing key before applying it. You can install now, or defer ("Later"). A deferred update is hidden for 24 hours — you can revert this at any time from Settings → App Updates → Update notifications.\n\n4) Integrity of the installed bundle\nOn each launch the app also checks that the Service Worker URL matches the one saved at first install, and that no unexpected Service Worker is queued. A mismatch triggers the "possible compromise detected" alert.\n\nIf you see that alert: verify the version on github.com/nostra-chat/nostra-chat before proceeding. If it still appears after that, "Reinstall app" (under Advanced) clears the cached code and forces a fresh download from the verified sources — the safest recovery, because you trust the re-downloaded copy rather than whatever was already on the device.',
  ...
  'Update.Consent.Title': 'Update available',
  'Update.Consent.FieldVersion': 'Version',
  'Update.Consent.FieldCommit': 'Commit',
  'Update.Consent.FieldDate': 'Date',
  'Update.Consent.FieldSigningKey': 'Signing key',
  'Update.Consent.SameAsInstalled': '✓ same as installed',
  'Update.Consent.FieldRotation': 'Key rotation',
  'Update.Consent.RotatesTo': 'This release rotates the signing key to',
  'Update.Consent.ReleaseNotes': 'Release notes',
  'Update.Consent.ChunksVerified': '%1$d/%2$d chunks verified',
  'Update.Consent.Ignore': 'Ignore',
  'Update.Consent.Accept': 'Accept',
  'Update.Consent.Applying': 'Applying…',
  'Update.Consent.AppliedReloadPrompt': 'Update applied. Reload now?',
  ...
  'Update.Compromise.Title': 'Possible compromise detected',
  'Update.Compromise.Body': 'The app distribution system is serving different content than expected. For safety, the application has been blocked.',
  'Update.Compromise.ShowDetails': 'Show technical details',
  'Update.Compromise.HideDetails': 'Hide technical details',
  'Update.Compromise.Todo1': 'Close the app and try again later',
  'Update.Compromise.Todo2': 'Verify the version on github.com/nostra-chat/nostra-chat',
  'Update.Compromise.Todo3': 'Do not enter passwords or sensitive data',
  'Update.Compromise.CloseButton': 'Close application',
  'Update.Compromise.Recovery.Note': 'Are you sure you are NOT under attack? If this alert appeared after a legitimate update or a first-time Phase A install, you can reset the baseline and restart the app. The reset does NOT uninstall the app or erase your Nostra identity.',
  'Update.Compromise.Recovery.Button': 'Reset update baseline',
  'Update.Compromise.Recovery.ConfirmButton': 'Confirm baseline reset',
  'Update.Sources.Title': 'Integrity sources',
  'Update.Sources.OpenInTab': 'Open',
  'Update.Compromise.CopyDiagnostics': 'Copy diagnostics',
  'Update.Compromise.DiagnosticsCopied': 'Diagnostics copied to clipboard',
  'Update.Compromise.DiagnosticsCopyFailed': 'Copy failed'
};
